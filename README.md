...
libraryDependencies ++= Seq(
  "net.ghoula" %% "eru-core" % "1.0.0-alpha",
  "net.ghoula" %% "eru-runtime" % "1.0.0-alpha"
)
```

Eru builds against Scala 3.8.4 on JDK 25.
...
Eru is at version 1.0.0-alpha. The core API is stable; breaking changes may still occur before 1.0.0.
