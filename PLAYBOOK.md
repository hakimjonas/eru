...
- [x] unsafeRunSync re-throws Throwable, wraps typed non‑Throwable in EruException.
- [x] Updated Scaladoc for unsafeRunSync and EruException.
- [x] attempt, fromOption, unit are implemented with comprehensive tests.
- [x] Quickstart and API docs added in docs-src and pass mdoc.
...
- [x] Interpreter: adjust unsafeRunSync to re‑throw Throwable and wrap non‑Throwable in EruException; update Scaladoc.
- [x] Add Eru#attempt, Eru#fromOption, Eru#unit (+ tests).
- [x] Expand tests for interpreter behavior; add mixed error channels (E | Throwable) scenarios.
- [x] Write docs-src/quickstart.md and docs-src/api pages for Eru/Result; show attempt‑first usage.
