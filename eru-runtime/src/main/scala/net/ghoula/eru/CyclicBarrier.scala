...
trait CyclicBarrier {
  ...
  /** Returns the number of parties required to trip this barrier.
    ...
    */
  def parties: Immediate[Nothing, Int]
  ...
  /** Returns the number of parties currently waiting at the barrier.
    ...
    */
  def waiting: Immediate[Nothing, Int]
...
object CyclicBarrier {
  ...
  private final class RuntimeCyclicBarrier(partyCount: Int, stateRef: Ref[BarrierState], runtime: EruRuntime)
      extends CyclicBarrier {

    def parties: Immediate[Nothing, Int] =
      new Immediate(Eru.succeed(partyCount))
