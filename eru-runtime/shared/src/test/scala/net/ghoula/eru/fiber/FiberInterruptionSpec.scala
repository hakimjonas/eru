...
/** Comprehensive tests for fiber interruption and cancellation scenarios.
  *
  * Tests complex interruption patterns to ensure cancellation is propagated correctly
  * and cooperative interruption works as expected in the unified fiber runtime.
  */
