...
object CorePrelude {
  ...
  val Eru: net.ghoula.eru.Eru.type = net.ghoula.eru.Eru

  /** The foundational result type for fallible computations. */
  type Result[+E, +A] = net.ghoula.eru.Result[E, A]
  val Result: net.ghoula.eru.Result.type = net.ghoula.eru.Result

  /** Export all factory methods from the Eru companion object.
    *
    * This includes: succeed, fail, effect, blocking, fromEither, fromTry, fromOption, unit
    */
  ...
  val ParallelErrors: net.ghoula.eru.ParallelErrors.type = net.ghoula.eru.ParallelErrors
