...
The key difference: recursive functions create deep call stacks in **Scala itself**, while iterative approaches create deep `flatMap` chains in **Eru's data structure**, which the runtime handles safely.
